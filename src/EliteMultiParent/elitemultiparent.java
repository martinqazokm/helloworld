package EliteMultiParent;

import java.util.Random;

public class elitemultiparent {
	//函数系数
...
/*		for (int i=0; i<n.length; i++)
	...
	/*public boolean restriction(double x1, double x2, double x3, double x4, double x5) {
		if (p1+p2*x2*x5+p3*x1*x4+p4*x3*x5>=0 && p1+p2*x2*x5+p3*x1*x4+p4*x3*x5<=92
				&& q1+q2*x2*x5+q3*x1*x2+q4*x3*x3>=90 && q1+q2*x2*x5+q3*x1*x2+q4*x3*x3<=110
				&& r1+r2*x3*x5+r3*x1*x3+r4*x3*x4>=20 && r1+r2*x3*x5+r3*x1*x3+r4*x3*x4<=25)
			return true;
